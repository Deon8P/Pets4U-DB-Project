...
namespace Pets4U
{
    class Database_Class
    {
                                       ...
                                       int Pet_Number, string Pet_Name, string Pet_Type, DateTime Appointment_Date, string Appointment_Time, int Clinic_Number)
        {
            ...
            param[4] = new MySqlParameter("Owner_Tel", MySqlDbType.VarChar);
            ...
            param[9] = new MySqlParameter("Appointment_Time", MySqlDbType.VarChar);
       ...
       public void insert_pet_owner(int own_num, string own_LName, string own_FName, string own_street, string own_city,
           string own_state, int own_zip, string own_tel, string pet_name, int clinic_number)
        {
       ...
       public void insert_pet(int pet_num, string pet_name, string pet_type, string pet_description, DateTime pet_bday, DateTime  pet_reg_date, string pet_status, int own_num, int clinic_number)
        ...
        public void insert_surgical_supplies(int supply_num, int clinic_num, string supply_name, string supply_description,
            int quantity_of_stock, int reorder_level,int reorder_quantity, double supply_cost)
        {
        ...
        public void insert_non_surgical_supplies(int supply_num, string supply_name, string supply_description, int quantity_of_stock, 
            int reorder_level, int reorder_quantity, double supply_cost, int clinic_num)
        {
            MySqlParameter[] param = new MySqlParameter[8];
        ...
        public void insert_pharma_supplies(int drug_num, int clinic_number, string drug_name, string drug_description, double drug_dosage, 
            string method_of_admin, int quantity_in_stock, int reorder_level, int reorder_quantity, double drug_cost)
        {
            MySqlParameter[] param = new MySqlParameter[10];
